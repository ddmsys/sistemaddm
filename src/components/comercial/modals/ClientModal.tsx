      ...
      <div className="max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-xl">
        ...
        <div className="max-h-[calc(90vh-140px)] overflow-y-auto p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Dados Básicos */}
            <div>
              <h3 className="mb-4 text-lg font-medium text-primary-900">Dados Básicos</h3>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder={
                      clientType === 'fisica' ? 'Nome completo' : 'Razão social da empresa'
                    }
                  />
            ...
            {/* Endereço */}
            <div>
              <h3 className="mb-4 text-lg font-medium text-primary-900">Endereço (Opcional)</h3>

              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div>
                  <label className="mb-1 block text-sm font-medium text-primary-700">CEP</label>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-4">
                <div>
                  <label className="mb-1 block text-sm font-medium text-primary-700">Número</label>
                  <input
                    type="text"
                    className="h-12 w-full rounded-md border border-primary-200 px-3 text-lg focus:border-transparent focus:ring-2 focus:ring-blue-500"
                ...
                <div className="md:col-span-2">
                  <label className="mb-1 block text-sm font-medium text-primary-700">Bairro</label>
                  <input
                    type="text"
                    className="h-12 w-full rounded-md border border-primary-200 px-3 text-lg focus:border-transparent focus:ring-2 focus:ring-blue-500"
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                <div className="md:col-span-2">
                  <label className="mb-1 block text-sm font-medium text-primary-700">Cidade</label>
                  <input
                    type="text"
                    className="h-12 w-full rounded-md border border-primary-200 px-3 text-lg focus:border-transparent focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-primary-700">Estado</label>
                  <input
                    type="text"
                    className="h-12 w-full rounded-md border border-primary-200 px-3 text-lg focus:border-transparent focus:ring-2 focus:ring-blue-500"
